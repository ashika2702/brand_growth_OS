      ...
      <div className="h-full flex flex-col pt-4 overflow-y-auto no-scrollbar">
         ...
         <div className="grid grid-cols-3 gap-8 pb-10">
            ...
            <div className="col-span-1 border-l border-white/5 pl-8 flex justify-center">
               <div className="w-[300px] h-[600px] border-[8px] border-black rounded-[3rem] bg-[#0A0D14] shadow-2xl overflow-hidden relative scale-90 origin-top">
                  <div className="absolute top-0 left-1/2 -translate-x-1/2 w-32 h-6 bg-black rounded-b-xl z-20" />
                  <div className="p-6 h-full flex flex-col pt-12 relative">
                     <div className="w-12 h-12 rounded-xl bg-accent-blue mx-auto mb-4 flex items-center justify-center text-white font-black shadow-[0_0_15px_rgba(62,128,255,0.4)]">BOS</div>
                     <h3 className="text-center text-white font-black text-lg mb-2 uppercase italic tracking-tighter">Claim Your Brief</h3>
                     <p className="text-center text-slate-400 text-[10px] font-medium leading-relaxed mb-8">Enter your details and the AI will analyze your digital footprint instantly.</p>

                     <div className="space-y-4">
                        <div className="h-12 bg-white/5 rounded-xl border border-white/10 px-4 flex items-center text-slate-500 text-[10px] font-black uppercase tracking-widest">Full Name</div>
                        <div className="h-12 bg-white/5 rounded-xl border border-white/10 px-4 flex items-center text-slate-500 text-[10px] font-black uppercase tracking-widest">Email Address</div>
                        <div className="h-12 bg-white/5 rounded-xl border border-white/10 px-4 flex items-center text-slate-500 text-[10px] font-black uppercase tracking-widest">Phone (Optional)</div>
                     </div>

                     <div className="mt-8 bg-accent-blue rounded-xl py-4 text-center text-white font-black text-[10px] uppercase tracking-widest shadow-[0_0_15px_rgba(62,128,255,0.3)]">Initialize Analysis ➔</div>

                     <div className="mt-auto pt-4 flex flex-col items-center gap-1 opacity-20">
