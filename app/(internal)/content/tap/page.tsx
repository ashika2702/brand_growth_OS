  ...
  return (
    <div className="h-full flex flex-col gap-6 overflow-hidden">
      ...
      <div className="flex justify-between items-end">
        ...
        <button className="px-6 py-3 bg-gradient-to-br from-purple-500 to-indigo-600 text-white rounded-2xl text-[10px] font-black uppercase tracking-widest shadow-[0_0_20px_rgba(168,85,247,0.3)] hover:scale-[1.02] transition-all flex items-center gap-2 group">
      ...
      <div className="grid grid-cols-12 gap-6 flex-1 min-h-0">
        ...
        <div className="col-span-12 lg:col-span-5 glass-card p-8 rounded-[2.5rem] border border-white/5 flex flex-col h-full bg-[#1A0B2E]/20">
          <div className="mb-8">
            <h3 className="text-[10px] font-black uppercase tracking-[0.2em] text-purple-400 mb-6 flex items-center gap-2">
            ...
            <div className="space-y-6">
              <div className="space-y-3">
                ...
                <div className="grid grid-cols-2 gap-2">
                  <button className="px-4 py-3 bg-purple-500/10 border border-purple-500/30 rounded-xl text-[10px] font-black uppercase text-purple-400 hover:bg-purple-500/20 transition-all">Business Brain</button>
                ...
                <div className="grid grid-cols-3 gap-2">
                  {[
                    ...
                    <button key={i} className="flex flex-col items-center gap-2 p-4 bg-white/5 border border-white/5 rounded-2xl hover:border-purple-400/30 transition-all group">
                       <type.icon size={18} className="text-slate-600 group-hover:text-purple-400 transition-colors" />
              ...
              <div className="space-y-3">
                ...
                <textarea 
                  ...
                  className="w-full bg-white/5 border border-white/5 focus:border-purple-500/50 rounded-[1.5rem] p-5 text-sm h-32 text-white placeholder:text-slate-700 outline-none transition-all resize-none"
                />
              </div>
            </div>
          </div>
          
          <button className="mt-auto w-full py-5 bg-gradient-to-r from-purple-500/20 to-indigo-600/20 border border-purple-500/30 text-purple-400 rounded-2xl text-[11px] font-black uppercase tracking-[0.3em] hover:bg-purple-500 group transition-all hover:text-white shadow-2xl">
        ...
        <div className="col-span-12 lg:col-span-7 flex flex-col gap-6 min-h-0">
          ...
          <div className="glass-card p-8 rounded-[2.5rem] border border-white/5 flex-1 overflow-hidden flex flex-col">
            ...
            <div className="flex-1 overflow-y-auto no-scrollbar space-y-4">
               {[
                 { title: 'The SEO Fallacy', type: 'LinkedIn Post', time: '12m ago', color: 'text-purple-400' },
                 { title: 'Scale or Die', type: 'Ad Headline', time: '1h ago', color: 'text-teal-400' },
                 { title: 'AEO Masterclass', type: 'Email Hero', time: '3h ago', color: 'text-blue-400' },
                 { title: 'Neural Campaign V1', type: 'Strategy Doc', time: '1d ago', color: 'text-purple-400' },
               ].map((asset, i) => (
                 <div key={i} className="group p-5 bg-white/5 rounded-3xl border border-white/5 hover:border-white/10 transition-all flex items-center gap-4 cursor-pointer">
                    ...
                    <div className="flex-1 min-w-0">
                       <h4 className="text-sm font-black text-white truncate group-hover:text-purple-400 transition-colors mb-0.5">{asset.title}</h4>
