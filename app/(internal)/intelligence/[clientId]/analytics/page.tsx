    ...
    <div className="glass-card p-6 rounded-[1.5rem] border border-border-1 relative overflow-hidden group transition-all hover:scale-[1.02]">
      ...
      <div className="flex justify-between items-start mb-4">
        ...
        <div className="text-right">
          ...
          <h4 className="text-2xl font-bold text-text-primary tracking-tighter mt-1">{value}</h4>
        </div>
      </div>
...
export default function GA4Dashboard() {
  ...
  const CustomTooltip = ({ active, payload, label }: any) => {
    if (active && payload && payload.length) {
      ...
      // Sort payload so "Total" comes first
      ...
      <div className="h-full flex items-center justify-center p-8">
        <div className="max-w-md w-full glass-card p-10 rounded-[2rem] border border-white/5 text-center space-y-6">
          ...
          <div className="space-y-2">
            <h2 className="text-2xl font-bold text-text-primary tracking-tighter uppercase text-balance">Analytics Required</h2>
  ...
  return (
    <div className="h-full bg-background flex flex-col gap-6 overflow-y-auto no-scrollbar pb-10 animate-in fade-in duration-700 p-8">
      {/* Header */}
      <div className="flex justify-between items-end">
        <div className="space-y-1">
          <div className="flex items-center gap-3">
             <button onClick={() => router.back()} className="p-2 bg-surface-2 rounded-xl text-text-muted hover:text-text-primary transition-colors border border-border-1">
              ...
              <h1 id="realtime" className="text-2xl font-bold text-text-primary tracking-tighter uppercase">
        ...
        <div className="flex items-center gap-4">
          ...
          <div className="relative">
            ...
            {isRangeOpen && (
              <div className="absolute top-full right-0 mt-2 w-72 glass-card border border-white/10 rounded-[2rem] p-5 animate-in zoom-in-95 duration-200 z-[100]">
                <div className="space-y-1 mb-4">
                  {[
                    ...
                    <button
                      ...
                      className={`w-full text-left px-5 py-4 rounded-2xl text-[10px] font-bold uppercase tracking-widest transition-all ${range === r.id && !customDates ? 'bg-accent-orange text-white shadow-[0_10px_20px_rgba(255,77,0,0.2)]' : 'text-slate-400 hover:bg-white/5 hover:text-white'}`}
                    >
                      {r.label}
                    </button>
                  ))}
      ...
      {view === 'traffic_acquisition' ? (
           ...
           <div className="glass-card p-10 rounded-[2rem] border border-border-1 relative overflow-hidden group">
              <div className="flex flex-col gap-10">
                 ...
                 <div className="flex justify-between items-start">
                   <div>
                     <h2 className="text-xl font-bold text-text-primary tracking-tighter uppercase flex items-center gap-2">
        ...
        <>
          {/* User Acquisition Section (Fidelity Implementation) */}
          <div className="space-y-6">
        <div className="glass-card p-10 rounded-[2rem] border border-border-1 relative overflow-hidden group">
          <div className="flex flex-col gap-10">
             {/* Section Header */}
             ...
             <div className="h-[300px] w-full">
               <ResponsiveContainer width="100%" height="100%">
                 <AreaChart data={acquisitionChartData}>
                   ...
                   />
                     {/* 1. Total Line (Bottom Layer - Blue Dotted) */}
                     <Area 
                       type="monotone" 
                       dataKey="Total" 
                       stroke="#00A3FF"
                     ...
                     {/* 2. Channel Layers (Direct on Top) */}
      ...
      <div className="grid grid-cols-12 gap-6">
        {/* Main Charts Area (Condensed for balance) */}
        <button 
        ...
        >
           ...
           <div className="flex justify-between items-center mb-8 relative z-10">
              <h3 className="text-[10px] font-bold uppercase tracking-[0.2em] text-text-primary flex items-center gap-2">
        ...
        <div className="col-span-12 lg:col-span-5 glass-card p-8 rounded-[2rem] border border-border-1 flex flex-col relative overflow-hidden group">
           <h3 className="text-[10px] font-bold uppercase tracking-[0.2em] text-text-primary mb-8 flex items-center gap-2 relative z-10">
